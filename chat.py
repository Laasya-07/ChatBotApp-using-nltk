    ...
    if prob.item() > 0.75:
        for intent in intents['intents']:
            if tag == intent["tag"]:
                ...
                if "redirect" in intent:
                    return {"answer": response, "redirect": intent["redirect"]}
                return {"answer": response}

    return {"answer": "I am not trained to respond to this. Kindly reach out to the support executive for further queries..."}
